...
|         v                                                         |
|   +-------------+                                                 |
|   |   .iter()   |  --> [1, 2, 3, 4, 5] (lazy iterator)            |
|   +------+------+                                                 |
|          |                                                        |
|          v                                                        |
|   +-------------+                                                 |
|   |  .map(|x|   |  --> [2, 4, 6, 8, 10] (still lazy!)             |
|   |    x * 2)   |                                                 |
|   +------+------+                                                 |
|          |                                                        |
|          v                                                        |
|   +-------------+                                                 |
|   | .filter(|x| |  --> [6, 8, 10] (still lazy!)                   |
|   |   x > &5)   |                                                 |
|   +------+------+                                                 |
|          |                                                        |
|          v                                                        |
|   +-------------+                                                 |
|   |   .sum()    |  --> 24 (NOW it executes!)                      |
|   +-------------+      <--- Consumer                              |
|                                                                   |
+-------------------------------------------------------------------+
|   Key: Adapters (map, filter) = lazy                              |
|        Consumers (sum, collect) = trigger execution               |
+-------------------------------------------------------------------+
```
